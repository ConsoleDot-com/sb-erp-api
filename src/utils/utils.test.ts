...
const {ghasuDryMaterial,calculateCrushCft,
    crushDryMaterial,
    calculateCrushSandCft,
    calculateCrushCementCft,calculateBajarSandCft,calculateBajarCft,bajarDryMaterial,calculateBajarCementCft} = require("./utils");
...
describe("Sand CFT", ()=>{
    test("Calculate Sand CFT", ()=>{
        expect(calculateSandCft(4,1,dryMaterial(calculateWallCft(5,15,2)))).toBe(156);
    });
});

describe("Cement CFT", ()=>{
    test("Calculate Cement CFT", ()=>{
        expect(calculateCementBags(4,1,dryMaterial(calculateWallCft(5,15,2)))).toBe(195);
    });
});
...
// describe("Ghasu CFT",()=>{
//     test("Calculate Ghasu GFT", ()=>{
//         expect(ghasuCft(1,2,3)).toBe(6);
//     })
// })

// describe("Ghasu Dry Material", ()=>{
//     test("Calculate Ghasu Dry Materilal", ()=>{
//         expect(ghasuDryMaterial(ghasuCft(15,5,2))).toBe(195);
//     })
// })

// describe("Ghasu Sand CFT", ()=> {
//     test("Calculate Ghasu Sand CFT", ()=>{
//         expect(calculateGhasuSandCft(1, 4 , 5 ,ghasuDryMaterial(ghasuCft(15,5,2)))).toBe(19.5);
//     })
// })

// describe("Ghasu Cement CFT", ()=> {
//     test("Calculate Ghasu Cement CFT", ()=>{
//         expect(calculateGhasuCementCft(1, 4 , 5 ,ghasuDryMaterial(ghasuCft(15,5,2)))).toBe(97.5);
//     })
// })

// describe("Ghasu Bajar CFT", ()=> {
//     test("Calculate Ghasu Bajar CFT", ()=>{
//         expect(calculateGhasuBajarCft(1, 4 , 5 ,ghasuDryMaterial(ghasuCft(15,5,2)))).toBe(97.5);
//     })
// })
...
describe("Bajar Sand CFT", ()=> {
    test("Calculate Bajar Sand CFT", ()=>{
        expect(calculateBajarSandCft(1, 4 , 5 ,bajarDryMaterial(calculateBajarCft(15,5,2)))).toBe(19.5);
    })
})

describe("Bajar Cement CFT", ()=> {
    test("Calculate Bajar Cement CFT", ()=>{
        expect(calculateBajarCementCft(1, 4 , 5 ,bajarDryMaterial(calculateBajarCft(15,5,2)))).toBe(97.5);
        })
    })
    ...
    describe("Crush Sand CFT", ()=> {
        test("Calculate Crush Sand CFT", ()=>{
            expect(calculateCrushSandCft(1, 4 , 5 ,crushDryMaterial(calculateCrushCft(15,5,2)))).toBe(19.5);
        })
    })
    
    describe("Crush Cement CFT", ()=> {
        test("Calculate Crush Cement CFT", ()=>{
            expect(calculateCrushCementCft(1, 4 , 5 ,crushDryMaterial(calculateCrushCft(15,5,2)))).toBe(97.5);
            })
        })
